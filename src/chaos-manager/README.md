...
| image.repository | string | `"harness/smp-chaos-manager"` |  |
| image.tag | string | `"0.13.5"` |  |
...
| jobs.chaos_db_upgrade.image.repository | string | `"harness/smp-chaos-db-upgrade-agent"` |  |
| jobs.chaos_db_upgrade.image.tag | string | `"0.13.1"` |  |
...
| logWatcherImage.image.tag | string | `"0.13.0"` |  |
| maxSurge | int | `1` |  |
...
| subscriberImage.image.tag | string | `"0.13.1"` |  |
| tolerations | list | `[]` |  |

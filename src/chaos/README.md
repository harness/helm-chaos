...
| chaos-driver.resources.limits.cpu | string | `"250m"` |  |
| chaos-driver.resources.limits.memory | string | `"256Mi"` |  |
| chaos-driver.resources.requests.cpu | string | `"250m"` |  |
| chaos-driver.resources.requests.memory | string | `"256Mi"` |  |
...
| chaos-manager.resources.limits.cpu | string | `"250m"` |  |
| chaos-manager.resources.limits.memory | string | `"1024Mi"` |  |
| chaos-manager.resources.requests.cpu | string | `"250m"` |  |
| chaos-manager.resources.requests.memory | string | `"1024Mi"` |  |
